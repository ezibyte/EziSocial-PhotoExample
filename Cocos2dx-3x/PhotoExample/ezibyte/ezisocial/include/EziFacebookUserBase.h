...
typedef std::function<void(cocos2d::Ref* fbUser, cocos2d::Sprite* userPhoto)> EziCallback;
//typedef std::function<void(cocos2d::Sprite* userPhoto)> EziCallback;
...
public:
    ...
    void callbackTest(const EziCallback& callback);
